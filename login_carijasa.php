...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$stmt = $conn->prepare('SELECT * FROM pencari_jasa WHERE pcr_email= ?');
...
<head>
	...
	<title>Pencari Jasa Login Page</title>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title text-center">LOGIN PENCARI JASA</h4>
							<form action="" method="POST" class="my-login-validation" novalidate="">
								...
								<div class="mt-4 text-center">
									Don't have an account? <a href="register_carijasa.php">Create One</a>
								</div>
							</form>
						</div>
					</div>
