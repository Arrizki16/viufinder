    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Jadikan Setiap Momen Berharga</span></h2>
          <h2 class="animate__animated animate__fadeInDown">Menjadi Lebih Berharga</span></h2>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Lampaui Dirimu</h2>
          <h2 class="animate__animated animate__fadeInDown">Dengan Momen Terbaikmu</h2>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Perbaiki Momen Terbaikmu</h2>
          <h2 class="animate__animated animate__fadeInDown">Dengan Foto Terbaikmu</h2>
        </div>
      </div>
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
            <div class="icon-box">
              ...
              <p class="description">Kami melayani dengan talent profesional</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title">Harga Bersahabat</h4>
              <p class="description">Dapatkan keperluan fotografimu dengan harga optimal</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4 class="title">Berkualitas</h4>
              <p class="description">Kulitas internasional dengan talent profesional</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title">Terjamin</h4>
              <p class="description">Hasil sesuai dengan harapan Anda</p>
            </div>
          </div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About Us</h2>
          <p>Viufinder adalah sebuah layanan yang bergerak dibidang fotografi di Indonesia. Viufinder berdiri sejak
            2021 dan telah melayani ribuan pelanggan dengan rating yang memuaskan. Tentunya Kami akan terus meningkatkan
            layanan Viufinder dan menjadi layanan fotografi terbesar di Indonesia.
          </p>
        </div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Pilih layanan yang telah kami sediakan</p>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Memberikan layanan fotografi dari talent fotografer terbaik dan berkualitas internasional</p>
            </div>
          </div>
          <div class="col-md-4 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4>Jasa Editor</h4>
              <p>Memberikan jasa editing foto Anda dari talent editor foto terbaik</p>
            </div>
          </div>
          <div class="col-md-4 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              <i class="bi bi-binoculars"></i>
              <h4>Jasa Penyewaan Alat Fotografi</h4>
              <p>Memberikan layanan sewa alat fotografer untuk menemani setiap momenmu yang menarik</p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-5">
            <div class="info">
              <div class="address">
                ...
                <h4>Alamat:</h4>
                <p>Treasury Tower, 7th Floor
                  Jl. Jenderal Sudirman Kav 52-53, Senayan, Jakarta 12190.</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>hello@viufinder.com</p>
              </div>
