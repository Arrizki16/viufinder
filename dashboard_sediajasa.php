...
<div class="col-md-12">  
    ...
    <div class="col-md-8"> 
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md" id="profil">
                    ...
                    <span class="caption-subject font-blue-madison bold uppercase">Profil Penyedia Jasa</span>
                </div>
            </div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md" id="jadwalpesanan">
                    <i class="icon-globe theme-font hide"></i>
                    <span class="caption-subject font-blue-madison bold uppercase">Jadwal Pesanan</span>
                </div>
            </div>
            <div class="portlet-body">
                <div class="d-flex">
