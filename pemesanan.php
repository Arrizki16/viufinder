    ...
    <div class="row main">
        ...
        <div class="row r1">
            ...
            <div class="row" style="padding: top 16px;">
                <h6 class="text-muted text-end" style="margin-left: 0%;"><br>ORDER TOTAL:</h6>
                <h3 class="text-end">Rp.250.000</h3>
            </div>
        </div>
            ...
            <form action="" method="post">
                ...
                <?php
                    ...
                    if(!is_null($row['ftg_id'])) {
                        ...
                        echo "<input class='btn-check' type='radio' name='jenisjasa' id='jenisjasaftg' value='1'".$isChecked.">";
                    ...
                    if(!is_null($row['edtr_id'])) {
                        echo "<div class='form-check-inline'>";
                        echo "<input class='btn-check' type='radio' name='jenisjasa' id='jenisjasaedtr' value='2'".$isChecked.">";
                    ...
                    if(!is_null($row['palat_id'])) {
                        echo "<div class='form-check-inline'>";
                        echo "<input class='btn-check' type='radio' name='jenisjasa' id='jenisjasapalat' value='3'".$isChecked.">";
